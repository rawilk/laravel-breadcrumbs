...
> {tip} See [Defining Breadcrumbs](/docs/laravel-breadcrumbs/v3/usage/defining-breadcrumbs) for more details.
...
> {tip} See [Custom Templates](/docs/laravel-breadcrumbs/v3/usage/custom-templates) for more details.
...
> [Route-Bound Breadcrumbs](/docs/laravel-breadcrumbs/v3/advanced-usage/route-bound-breadcrumbs) for a way to link
